...
// app/page.tsx's own header comment for the full reasoning. Distinct path
// from Capriowear's own /capriowear/terms-of-service (no collision, no
// redirect involved).
...
import { termsStub } from "@/content/capriosports/stubPages";
...
export const metadata: Metadata = {
  title: termsStub.metaTitle,
  description: termsStub.metaDescription,
  ...
  openGraph: {
    title: `${termsStub.metaTitle} | ${PARENT_SITE_NAME}`,
    description: termsStub.metaDescription,
    url: CANONICAL,
