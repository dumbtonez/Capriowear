...
// hadn't been quite what was wanted). Briefly replaced 2026-09-11 by
// `InstagramIcon`'s own `gradient` prop (Meta's real brand gradient), then
// reverted back to this tone-adaptive version, 2026-09-13 (owner: "make it
// back to previous style when it gets white on black background and mid
// greish on white" -- "the same that we had before"). Reuses
// `getSurfaceToneAt` (lib/surfaceTone.ts, extracted from Header.tsx, where
// it already drives that fixed header's own adaptive text colour) rather
