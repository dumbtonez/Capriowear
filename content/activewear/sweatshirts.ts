...
export const sweatshirts: Category = {
  ...
  styleCards: [
    ...
    },
    {
      ...
      gender: "Men",
      sku: "CAP-SWT-02",
      pdpTitle: "Oversized French Terry Crewneck",
      pdpHeading: "Custom Oversized French Terry Crewneck Sweatshirt Manufacturer",
      pdpDescription:
      ...
      images: [
        { alt: "Oversized French terry crewneck sweatshirt, front view" },
        { alt: "Oversized French terry crewneck sweatshirt, back view" },
        { alt: "Oversized French terry crewneck sweatshirt, drawcord hem detail" },
        { alt: "Oversized French terry crewneck sweatshirt, collar detail" },
        { alt: "Oversized French terry crewneck sweatshirt, worn on model" },
        { alt: "Oversized French terry crewneck sweatshirt, flat lay" },
      ],
      pdpMetaTitle: "Custom Oversized French Terry Crewneck Sweatshirt Manufacturer",
      pdpMetaDescription:
      ...
      specificationsImage: { alt: "Oversized French terry crewneck sweatshirt, construction detail" },
      pdpQualitySubline: "We confirm it all on your sample before a single bulk piece is cut.",
      pdpQualityPoints: [
        "Ribbed collar lies flat and holds its recovery, no curling",
        "GSM held consistent, batch to batch",
    ...
    },
    {
      ...
      cardTitle: "Custom Premium Technical Fleece Loose-Fit Crewneck Sweatshirt",
      cardSubline: "Loose fit, premium technical fleece, vent detailing",
      image: "",
      imageAlt: "Custom premium technical fleece loose-fit crewneck sweatshirt, loose fit, premium technical fleece, vent detailing",
      href: "/capriowear/activewear/sweatshirts/premium-technical-fleece",
      gender: "Men",
      sku: "CAP-SWT-08",
      pdpTitle: "Premium Technical Fleece Loose-Fit Crewneck",
      pdpHeading: "Custom Premium Technical Fleece Loose-Fit Crewneck Sweatshirt Manufacturer",
      pdpDescription:
      ...
      images: [
        { alt: "Premium technical fleece loose-fit crewneck sweatshirt, front view" },
        { alt: "Premium technical fleece loose-fit crewneck sweatshirt, back view" },
        { alt: "Premium technical fleece loose-fit crewneck sweatshirt, vent detail" },
        { alt: "Premium technical fleece loose-fit crewneck sweatshirt, collar detail" },
        { alt: "Premium technical fleece loose-fit crewneck sweatshirt, worn on model" },
        { alt: "Premium technical fleece loose-fit crewneck sweatshirt, flat lay" },
      ],
      pdpMetaTitle: "Custom Premium Technical Fleece Loose-Fit Crewneck Sweatshirt Manufacturer",
      pdpMetaDescription:
      ...
      relatedStyleTags: [
        { label: "Men's French Terry Crewneck", slug: "french-terry-mens", href: "/capriowear/activewear/sweatshirts" },
        { label: "Custom Reverse French Terry Crewneck", slug: "reverse-french-terry", href: "/capriowear/activewear/sweatshirts" },
        { label: "Men's Oversized Brushed Fleece Crewneck", slug: "oversized-brushed-fleece-mens", href: "/capriowear/activewear/sweatshirts" },
        { label: "Men's Technical Performance Crewneck", slug: "technical-performance-mens", href: "/capriowear/activewear/sweatshirts" },
        { label: "See All", href: "/capriowear/activewear/sweatshirts" },
      ],
      ...
      specificationsImage: { alt: "Premium technical fleece loose-fit crewneck sweatshirt, construction detail" },
      pdpQualitySubline: "We confirm it all on your sample before a single bulk piece is cut.",
      pdpQualityPoints: [
        "Ribbed collar lies flat and holds its recovery, no curling",
        "GSM held consistent, batch to batch",
    ...
    },
    {
      ...
      gender: "Men",
      sku: "CAP-SWT-09",
      pdpTitle: "Reverse French Terry Crewneck",
      pdpHeading: "Custom Reverse French Terry Crewneck Sweatshirt Manufacturer",
      pdpDescription:
      ...
      images: [
        { alt: "Reverse French terry crewneck sweatshirt, front view" },
        { alt: "Reverse French terry crewneck sweatshirt, back view" },
        { alt: "Reverse French terry crewneck sweatshirt, looped outer face detail" },
        { alt: "Reverse French terry crewneck sweatshirt, collar detail" },
        { alt: "Reverse French terry crewneck sweatshirt, worn on model" },
        { alt: "Reverse French terry crewneck sweatshirt, flat lay" },
      ],
      pdpMetaTitle: "Custom Reverse French Terry Crewneck Sweatshirt Manufacturer",
      pdpMetaDescription:
      ...
      relatedStyleTags: [
        { label: "Men's French Terry Crewneck", slug: "french-terry-mens", href: "/capriowear/activewear/sweatshirts" },
        { label: "Custom Premium Technical Fleece Loose-Fit Crewneck", slug: "premium-technical-fleece", href: "/capriowear/activewear/sweatshirts" },
        { label: "Custom Oversized French Terry Crewneck", slug: "oversized-french-terry", href: "/capriowear/activewear/sweatshirts" },
        { label: "Men's Oversized Brushed Fleece Crewneck", slug: "oversized-brushed-fleece-mens", href: "/capriowear/activewear/sweatshirts" },
        { label: "See All", href: "/capriowear/activewear/sweatshirts" },
      ],
      ...
      specificationsImage: { alt: "Reverse French terry crewneck sweatshirt, construction detail" },
      pdpQualitySubline: "We confirm it all on your sample before a single bulk piece is cut.",
      pdpQualityPoints: [
        "Ribbed collar lies flat and holds its recovery, no curling",
        "GSM held consistent, batch to batch",
