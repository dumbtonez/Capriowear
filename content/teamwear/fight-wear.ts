...
export const fightWear: Category = {
  ...
  metaDescription:
    "Custom BJJ and MMA rash guard manufacturer: rash guards, fight shorts and spats built to your competition's uniform rules, confirmed on your proof, low MOQ.",
  ...
  styleCards: [
    {
      ...
      cardSubline: "Sublimated flatlock rash guard, silicone grip hem, built to your competition's uniform rules, confirmed on your proof",
      image: "",
      imageAlt: "Custom long-sleeve rash guard, sublimated flatlock, silicone grip hem, built to your competition's uniform rules",
